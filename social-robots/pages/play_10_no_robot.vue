    ...
    <v-row justify="center" align="center">
      <v-col cols="4">
        <v-btn
          ...
          color="warning"
          @click="$router.push('/play_20_no_robot');"
      ...
      <v-col cols="4">
        <v-btn
          ...
          x-large
          style="width: 100%; height: 20vh; font-size: 40px;"
          @click="$router.push('/play_21_no_robot');"
      ...
      <v-col cols="12" class="px-0">
        <v-card class="align-center" style="height: max-content">
          <v-card-text class="justify-center align-center" style="text-align: center !important; display: block; font-size: 40px !important; line-height: 100%; padding: 0px;">
            ...
            <br />
            <div class="py-6" style="display: inline-flex;">
              <div v-for="n in 1" :key="n" class="mx-3" style="background-color: #888888; width: 30px; height: 40px;"></div>
            ...
            <div class="py-6" style="display: inline-flex;">
              <div v-for="n in 1" :key="n" class="mx-3" style="background-color: #888888; width: 30px; height: 40px;"></div>
              <span style="color: green; width: 30px" class="mx-1">O</span>
